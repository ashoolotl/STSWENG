...
router.get("/vehicle-classifications", authController.protect, authController.restrictTo("admin"), viewsController.getVehicleClassifications);
router.get("/services", viewsController.getServices);
router.get("/reviews/:serviceName", viewsController.getReviews);
