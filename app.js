...
const {deleteAllCarts, deleteCarByPlateNumber, deleteProductByName, deleteUserByEmail, deleteReceiptById } = require("./public/js/cypressDeletes");
...
app.delete("/api/v1/deleteAllCarts", async (req, res) => {
  try {
